...
export function Get<T extends EndpointMethod>(options: string | MethodDecoratorOptions = {}): TypedDecorator<T> {
    if (typeof options === "string") {
        options = { path: options };
    }

    return makeMethodDecorator(Get.name, Method.GET, options);
}

export function Post<T extends EndpointMethod>(options: string | MethodDecoratorOptions = {}): TypedDecorator<T> {
    if (typeof options === "string") {
        options = { path: options };
    }

    return makeMethodDecorator(Post.name, Method.POST, options);
}

export function Put<T extends EndpointMethod>(options: string | MethodDecoratorOptions = {}): TypedDecorator<T> {
    if (typeof options === "string") {
        options = { path: options };
    }

    return makeMethodDecorator(Put.name, Method.PUT, options);
}

export function Patch<T extends EndpointMethod>(options: string | MethodDecoratorOptions = {}): TypedDecorator<T> {
    if (typeof options === "string") {
        options = { path: options };
    }

    return makeMethodDecorator(Patch.name, Method.PATCH, options);
}

export function Delete<T extends EndpointMethod>(options: string | MethodDecoratorOptions = {}): TypedDecorator<T> {
    if (typeof options === "string") {
        options = { path: options };
    }

    return makeMethodDecorator(Delete.name, Method.DELETE, options);
}
